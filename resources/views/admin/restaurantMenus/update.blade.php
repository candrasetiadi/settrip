                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form class="form-horizontal" method="POST" action="{{ route('restaurantMenu.update', $restaurantMenu->id) }}">
                                {{method_field("PATCH")}}
                                {{ csrf_field() }}
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input id="name" class="form-control" type="text" name="name" value="{{ $restaurantMenu->name }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-prepend input-group">
                                            ...
                                            <textarea id="description" name="description" rows="3" class="form-control" placeholder="">{{ $restaurantMenu->description }}</textarea>
                                            <!-- <span class="input-group-addon">.00</span> -->
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input id="agent_rate" class="form-control" type="number" name="agent_rate" value="{{ $restaurantMenu->agent_rate }}">
                                            </div>
                                        </div>
                                    </div>   
                                    <div class="col-md-6">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input id="publish_rate" class="form-control" type="number" name="publish_rate" value="{{ $restaurantMenu->publish_rate }}">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input id="fee" class="form-control" type="number" name="fee" value="{{ $restaurantMenu->fee }}">
                                            </div>
                                        </div>
                                    </div>     
                                </div>
                                            ...
                                            <div class="input-group">
                                                <div class="checkbox">
                                                    <label for="is_recommended">
                                                        <input id="is_recommended" type="checkbox" name="is_recommended" value="is_recommended"> Is Recommended
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    var restaurantMenu = <?= json_encode($restaurantMenu) ?>

    $(document).ready(function() {
        
        $("#id_resto").val(restaurantMenu.id_resto).trigger('change')
        $("#type").val(restaurantMenu.type).trigger('change')
    })
</script>
