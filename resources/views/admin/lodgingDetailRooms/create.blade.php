                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form class="form-horizontal" method="POST" action="{{ url('admin/lodgingDetailRoom') }}">
                            	{{ csrf_field() }}
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="{{ route('lodgingDetailRoom.index') }}"><button type="button" class="btn btn-default">Cancel</button></a>
                                </div>
                            </form>
                        </div>
                    </div>
