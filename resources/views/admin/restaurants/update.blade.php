                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form class="form-horizontal" method="POST" action="{{ route('restaurant.update', $restaurant->id) }}">
                                {{method_field("PATCH")}}
                            	{{ csrf_field() }}
                                ...
                                <div class="form-group row">
                                	<div class="col-md-6">
	                                    ...
	                                    <div class="controls">
	                                        <div class="input-group">
	                                            <input id="name" class="form-control" type="text" name="name" value="{{ $restaurant->name }}">
                                	...
                                	<div class="col-md-6">
	                                    ...
	                                    <div class="controls">
	                                        <div class="input-group">
	                                            <input id="email" class="form-control" type="email" name="email" value="{{ $restaurant->email }}">
	                                        </div>
	                                    </div>
	                                </div>	                                    
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-prepend input-group">
                                            ...
                                            <textarea id="address" name="address" rows="3" class="form-control" placeholder="">{{ $restaurant->address }}</textarea>
                                            <!-- <span class="input-group-addon">.00</span> -->
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-prepend input-group">
                                            <!-- <span class="input-group-addon">$</span> -->
                                            <textarea id="description" name="description" rows="3" class="form-control" placeholder="">{{ $restaurant->description }}</textarea>
                                            <!-- <span class="input-group-addon">.00</span> -->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                	<div class="col-md-6">
	                                    ...
	                                    <div class="controls">
	                                        <div class="input-group">
	                                            <input id="phone_1" class="form-control" size="16" type="text" name="phone_1" value="{{ $restaurant->phone_1 }}">
	                                        </div>
	                                    </div>
                                	</div>
                                	<div class="col-md-6">
	                                    ...
	                                    <div class="controls">
	                                        <div class="input-group">
	                                            <input id="phone_2" class="form-control" size="16" type="text" name="phone_2" value="{{ $restaurant->phone_2 }}">
	                                        </div>
	                                    </div>
                                	</div>                          
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input id="open_hour" class="form-control timepickers" type="text" name="open_hour" value="{{ $restaurant->open_hour }}">
                                            </div>
                                        </div>
                                    </div>   
                                    <div class="col-md-6">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input id="close_hour" class="form-control timepickers" type="text" name="close_hour" value="{{ $restaurant->close_hour }}">
                                            </div>
                                        </div>
                                    </div>   
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input id="rating" class="form-control" type="text" name="rating" value="{{ $restaurant->rating }}">
                                            </div>
                                        </div>
                                    </div>   
                                    <div class="col-md-6">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input id="location_coordinate" class="form-control" type="text" name="location_coordinate" value="{{ $restaurant->location_coordinate }}">
                                            </div>
                                        </div>
                                    </div>   
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input id="maximum_person" class="form-control" type="number" name="maximum_person" value="{{ $restaurant->maximum_person }}">
                                            </div>
                                        </div>
                                    </div>   
                                    <div class="col-md-6">
