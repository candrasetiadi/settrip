                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form class="form-horizontal" method="POST" action="{{ route('transportation.update', $transportation->id) }}">
                                {{method_field("PATCH")}}
                            	{{ csrf_field() }}
                                	...
                                	<div class="col-md-6">
	                                    ...
	                                    <div class="controls">
                                            <div class="input-group">
                                                <input id="name" class="form-control" type="text" name="name" value="{{ $transportation->name }}">
                                            </div>
                                        </div>
	                                </div>	                                    
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-prepend input-group">
                                            ...
                                            <textarea id="description" name="description" rows="3" class="form-control" placeholder="">{{ $transportation->description }}</textarea>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input id="brand" class="form-control" type="text" name="brand" value="{{ $transportation->brand }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input id="seat_capacity" class="form-control" type="number" name="seat_capacity" value="{{ $transportation->seat_capacity }}">
                                            </div>
                                        </div>
                                    </div>                                    
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input id="door_amount" class="form-control" type="text" name="door_amount" value="{{ $transportation->door_amount }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input id="bag_capacity" class="form-control" type="number" name="bag_capacity" value="{{ $transportation->bag_capacity }}">
                                            </div>
                                        </div>
                                    </div>                                    
                                </div>
                                <div class="form-group row">
                                	<div class="col-md-6">
	                                    ...
	                                    <div class="controls">
	                                        <div class="input-group">
	                                            <input id="price" class="form-control" type="text" name="price" value="{{ $transportation->price }}">
	                                        </div>
	                                    </div>
                                	</div>
                                	<div class="col-md-6">
	                                    ...
	                                    <div class="controls">
	                                        <div class="input-group">
	                                            <input id="capacity" class="form-control" size="3" type="number" name="capacity" value="{{ $transportation->capacity }}">
	                                        </div>
	                                    </div>
                                	</div>                                    
                                </div>
                                ...
                                <div class="form-group row">
                                	...
                                	<div class="col-md-6">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                <input id="production_year" class="form-control yearpickers" type="text" name="production_year" value="{{ $transportation->production_year }}">
                                            </div>
                                        </div>
                                    </div>                                 
                                </div>                                
